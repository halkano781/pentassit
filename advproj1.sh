...
run_nuclei() {
    ...
    run_command "/home/halkano/Downloads/nuclei_3.2.8_linux_amd64/nuclei -u $url -o $target_directory/nuclei_results.txt"
}
...
main() {
    ...
    while true; do
        ...
        echo "7) Collect JavaScript endpoints with LinkFinder"
        echo "8) Vulnerability assessment with RapidScan (limited to 6 minutes)"
        echo "9) Run Nuclei for vulnerability severity"
